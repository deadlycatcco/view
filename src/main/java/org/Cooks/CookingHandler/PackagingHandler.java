...
public class PackagingHandler extends BaseHandler{
    public void prepare() {
        ...
        for(var pizza : pizzas) {
            ...
            System.out.println("Packaging pizza by "+ currentCook.getId()+"("+currentCook.getOrder().getId()+")");
            pizza.getNextStage();
        }
        Cook cook = null;

        currentCook.sendCompleteOrder();
    }
}
